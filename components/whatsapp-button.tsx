...
export function WhatsAppButton() {
  ...
  // Show tooltip briefly after becoming visible
  useEffect(() => {
    if (isVisible) {
          ...
          <AnimatePresence>
            {isTooltipVisible && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="hidden md:block bg-white rounded-lg shadow-lg px-4 py-2 border border-gray-100"
              >
                <p className="font-sans text-sm text-gray-700 whitespace-nowrap">
                  Chat with us! 💬
                </p>
                {/* Arrow */}
